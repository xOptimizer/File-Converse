            ...
            {action.is_error ? (
              ...
              <div className=" text-md flex items-center gap-4">
                ...
                <Select
                  ...
                  value={selcted}
                >
                  <SelectTrigger className="w-32 outline-none focus:outline-none focus:ring-0 text-center bg-background text-md font-medium">
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-secondary border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
